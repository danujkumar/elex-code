...
let bottom = [1, 2, 3, 4, 5, 6];
let right = [7, 8, 9, 10, 11, 12, 13];
let centerright = [14, 15, 16, 17, 18, 19];
let centertop = [20, 21, 22, 23];
let topup = [24, 25, 26];
...
let path24 = document.getElementById("path24");
let path25 = document.getElementById("path25");
let path26 = document.getElementById("path26");
let path27 = document.getElementById("path27");
let path28 = document.getElementById("path28");


function removeAlll() {
    for(let i=1;i<=28;i++)
    {
       let t = document.getElementById("path"+i).style.opacity = 0;
...
//   let firstrowdownpara = [];
  ...
  if (topup.includes(starting)) {

    if(bottom.includes(ending))
    {
        switch (ending) {
            case 6:
                path1Con(0); path2Con(0); path3Con(0); path4Con(0); path5Con(0); path6Con(0); path7Con(0); path8Con(0); path9Con(0); path10Con(0); path11Con(0); 
